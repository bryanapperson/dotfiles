-- Human Interface Device Bindings
...
hid.globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Escape", awful.tag.history.restore,
              {description = "go back to previous", group = "tag"}),
    ...
    awful.key({ modkey,           }, "Tab",
        ...
        {description = "go back to previous", group = "client"}),
    ...
    -- Layout manipulation
    awful.key({ modkey, "Alt" }, "j", function () awful.client.swap.byidx(  1)    end,
              {description = "swap with next client by index", group = "client"}),
    awful.key({ modkey, "Alt" }, "k", function () awful.client.swap.byidx( -1)    end,
    ...
    -- Show awesome menu
    -- TODO Integrate this with rofi and do away with it
...
hid.clientbuttons = gears.table.join(
